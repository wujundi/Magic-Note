...
ExceptionDetails:
  ...
  Location:
    ...
    io/debezium/connector/mysql/antlr/MySqlAntlrDdlParser.createNewParserInstance(Lorg/antlr/v4/runtime/CommonTokenStream;)Lorg/antlr/v4/runtime/Parser; @5: areturn

  Reason:

    Type'io/debezium/ddl/parser/mysql/generated/MySqlParser' (current frame, stack[0]) is not assignable to 'org/antlr/v4/runtime/Parser' (from method signature)
  ...
  CurrentFrame:
    ...
    locals: { 'io/debezium/connector/mysql/antlr/MySqlAntlrDdlParser', 'org/antlr/v4/runtime/CommonTokenStream' }

    stack: { 'io/debezium/ddl/parser/mysql/generated/MySqlParser' }
